...
//entity set member
	...
	this.PartnersSetups = new SAPB1.EntitySet('PartnersSetups', SAPB1.PartnersSetupParams, this);
	...
	this.RecurringTransaction = new SAPB1.EntitySet('RecurringTransaction', SAPB1.RclRecurringTransactionParams, this);
	...
	this.WorkOrders = new SAPB1.EntitySet('WorkOrders', SAPB1.WorkOrder, this);
