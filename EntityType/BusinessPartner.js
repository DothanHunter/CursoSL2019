...
SAPB1.BusinessPartner.DatevAccount = { valueOf: function(){return 'DatevAccount';}, Type: 'Edm.Int32', Index: 218, Nullable: true, IsArray: false, IsComplex: false };
...
SAPB1.BusinessPartner.GTSRegNo = { valueOf: function(){return 'GTSRegNo';}, Type: 'Edm.String', Index: 220, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.GTSBankAccountNo = { valueOf: function(){return 'GTSBankAccountNo';}, Type: 'Edm.String', Index: 221, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.GTSBillingAddrTel = { valueOf: function(){return 'GTSBillingAddrTel';}, Type: 'Edm.String', Index: 222, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.ETaxWebSite = { valueOf: function(){return 'ETaxWebSite';}, Type: 'Edm.Int32', Index: 223, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.HouseBankIBAN = { valueOf: function(){return 'HouseBankIBAN';}, Type: 'Edm.String', Index: 224, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.VATRegistrationNumber = { valueOf: function(){return 'VATRegistrationNumber';}, Type: 'Edm.String', Index: 225, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.RepresentativeName = { valueOf: function(){return 'RepresentativeName';}, Type: 'Edm.String', Index: 226, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.IndustryType = { valueOf: function(){return 'IndustryType';}, Type: 'Edm.String', Index: 227, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.BusinessType = { valueOf: function(){return 'BusinessType';}, Type: 'Edm.String', Index: 228, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.Series = { valueOf: function(){return 'Series';}, Type: 'Edm.Int32', Index: 229, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.AutomaticPosting = { valueOf: function(){return 'AutomaticPosting';}, Type: 'AutomaticPostingEnum', Index: 230, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.InterestAccount = { valueOf: function(){return 'InterestAccount';}, Type: 'Edm.String', Index: 231, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.FeeAccount = { valueOf: function(){return 'FeeAccount';}, Type: 'Edm.String', Index: 232, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.CampaignNumber = { valueOf: function(){return 'CampaignNumber';}, Type: 'Edm.Int32', Index: 233, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.AliasName = { valueOf: function(){return 'AliasName';}, Type: 'Edm.String', Index: 234, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.DefaultBlanketAgreementNumber = { valueOf: function(){return 'DefaultBlanketAgreementNumber';}, Type: 'Edm.Int32', Index: 235, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EffectiveDiscount = { valueOf: function(){return 'EffectiveDiscount';}, Type: 'DiscountGroupRelationsEnum', Index: 236, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.NoDiscounts = { valueOf: function(){return 'NoDiscounts';}, Type: 'BoYesNoEnum', Index: 237, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EffectivePrice = { valueOf: function(){return 'EffectivePrice';}, Type: 'EffectivePriceEnum', Index: 238, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.GlobalLocationNumber = { valueOf: function(){return 'GlobalLocationNumber';}, Type: 'Edm.String', Index: 239, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDISenderID = { valueOf: function(){return 'EDISenderID';}, Type: 'Edm.String', Index: 240, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDIRecipientID = { valueOf: function(){return 'EDIRecipientID';}, Type: 'Edm.String', Index: 241, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.ResidenNumber = { valueOf: function(){return 'ResidenNumber';}, Type: 'ResidenceNumberTypeEnum', Index: 242, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.RelationshipCode = { valueOf: function(){return 'RelationshipCode';}, Type: 'Edm.String', Index: 243, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.RelationshipDateFrom = { valueOf: function(){return 'RelationshipDateFrom';}, Type: 'Edm.DateTime', Index: 244, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.RelationshipDateTill = { valueOf: function(){return 'RelationshipDateTill';}, Type: 'Edm.DateTime', Index: 245, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.UnifiedFederalTaxID = { valueOf: function(){return 'UnifiedFederalTaxID';}, Type: 'Edm.String', Index: 246, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.AttachmentEntry = { valueOf: function(){return 'AttachmentEntry';}, Type: 'Edm.Int32', Index: 247, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.TypeOfOperation = { valueOf: function(){return 'TypeOfOperation';}, Type: 'TypeOfOperationEnum', Index: 248, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EndorsableChecksFromBP = { valueOf: function(){return 'EndorsableChecksFromBP';}, Type: 'BoYesNoEnum', Index: 249, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.AcceptsEndorsedChecks = { valueOf: function(){return 'AcceptsEndorsedChecks';}, Type: 'BoYesNoEnum', Index: 250, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.OwnerCode = { valueOf: function(){return 'OwnerCode';}, Type: 'Edm.Int32', Index: 251, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.BlockSendingMarketingContent = { valueOf: function(){return 'BlockSendingMarketingContent';}, Type: 'BoYesNoEnum', Index: 252, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.AgentCode = { valueOf: function(){return 'AgentCode';}, Type: 'Edm.String', Index: 253, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.PriceMode = { valueOf: function(){return 'PriceMode';}, Type: 'PriceModeEnum', Index: 254, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocGenerationType = { valueOf: function(){return 'EDocGenerationType';}, Type: 'EDocGenerationTypeEnum', Index: 255, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocStreet = { valueOf: function(){return 'EDocStreet';}, Type: 'Edm.String', Index: 256, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocStreetNumber = { valueOf: function(){return 'EDocStreetNumber';}, Type: 'Edm.String', Index: 257, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocBuildingNumber = { valueOf: function(){return 'EDocBuildingNumber';}, Type: 'Edm.Int32', Index: 258, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocZipCode = { valueOf: function(){return 'EDocZipCode';}, Type: 'Edm.String', Index: 259, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocCity = { valueOf: function(){return 'EDocCity';}, Type: 'Edm.String', Index: 260, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocCountry = { valueOf: function(){return 'EDocCountry';}, Type: 'Edm.String', Index: 261, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocDistrict = { valueOf: function(){return 'EDocDistrict';}, Type: 'Edm.String', Index: 262, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocRepresentativeFirstName = { valueOf: function(){return 'EDocRepresentativeFirstName';}, Type: 'Edm.String', Index: 263, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocRepresentativeSurname = { valueOf: function(){return 'EDocRepresentativeSurname';}, Type: 'Edm.String', Index: 264, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocRepresentativeCompany = { valueOf: function(){return 'EDocRepresentativeCompany';}, Type: 'Edm.String', Index: 265, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocRepresentativeFiscalCode = { valueOf: function(){return 'EDocRepresentativeFiscalCode';}, Type: 'Edm.String', Index: 266, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocRepresentativeAdditionalId = { valueOf: function(){return 'EDocRepresentativeAdditionalId';}, Type: 'Edm.String', Index: 267, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.EDocPECAddress = { valueOf: function(){return 'EDocPECAddress';}, Type: 'Edm.String', Index: 268, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.IPACodeForPA = { valueOf: function(){return 'IPACodeForPA';}, Type: 'Edm.String', Index: 269, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.UpdateDate = { valueOf: function(){return 'UpdateDate';}, Type: 'Edm.DateTime', Index: 270, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.UpdateTime = { valueOf: function(){return 'UpdateTime';}, Type: 'Edm.Time', Index: 271, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.ExemptionMaxAmountValidationType = { valueOf: function(){return 'ExemptionMaxAmountValidationType';}, Type: 'ExemptionMaxAmountValidationTypeEnum', Index: 272, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.ECommerceMerchantID = { valueOf: function(){return 'ECommerceMerchantID';}, Type: 'Edm.String', Index: 273, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.UseBillToAddrToDetermineTax = { valueOf: function(){return 'UseBillToAddrToDetermineTax';}, Type: 'BoYesNoEnum', Index: 274, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.BusinessPartner.BPAddresses = { valueOf: function(){return 'BPAddresses';}, Type: 'BPAddress', Index: 275, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.ContactEmployees = { valueOf: function(){return 'ContactEmployees';}, Type: 'ContactEmployee', Index: 276, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPAccountReceivablePaybleCollection = { valueOf: function(){return 'BPAccountReceivablePaybleCollection';}, Type: 'BPAccountReceivablePayble', Index: 277, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPPaymentMethods = { valueOf: function(){return 'BPPaymentMethods';}, Type: 'BPPaymentMethod', Index: 278, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPWithholdingTaxCollection = { valueOf: function(){return 'BPWithholdingTaxCollection';}, Type: 'BPWithholdingTax', Index: 279, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPPaymentDates = { valueOf: function(){return 'BPPaymentDates';}, Type: 'BPPaymentDate', Index: 280, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPBranchAssignment = { valueOf: function(){return 'BPBranchAssignment';}, Type: 'BPBranchAssignmentItem', Index: 281, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPBankAccounts = { valueOf: function(){return 'BPBankAccounts';}, Type: 'BPBankAccount', Index: 282, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPFiscalTaxIDCollection = { valueOf: function(){return 'BPFiscalTaxIDCollection';}, Type: 'BPFiscalTaxID', Index: 283, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.DiscountGroups = { valueOf: function(){return 'DiscountGroups';}, Type: 'DiscountGroup', Index: 284, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.BusinessPartner.BPIntrastatExtension = { valueOf: function(){return 'BPIntrastatExtension';}, Type: 'BPIntrastatExtension', Index: 285, Nullable: true, IsArray: false, IsComplex: true };
SAPB1.BusinessPartner.BPBlockSendingMarketingContents = { valueOf: function(){return 'BPBlockSendingMarketingContents';}, Type: 'BPBlockSendingMarketingContent', Index: 286, Nullable: true, IsArray: true, IsComplex: true };
...
SAPB1.BusinessPartner.prototype.DatevAccount = new Number();
