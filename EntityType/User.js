...
SAPB1.User.Locked = { valueOf: function(){return 'Locked';}, Type: 'BoYesNoEnum', Index: 11, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.Group = { valueOf: function(){return 'Group';}, Type: 'BoUserGroup', Index: 12, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.MaxDiscountGeneral = { valueOf: function(){return 'MaxDiscountGeneral';}, Type: 'Edm.Double', Index: 13, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.MaxDiscountSales = { valueOf: function(){return 'MaxDiscountSales';}, Type: 'Edm.Double', Index: 14, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.MaxDiscountPurchase = { valueOf: function(){return 'MaxDiscountPurchase';}, Type: 'Edm.Double', Index: 15, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.CashLimit = { valueOf: function(){return 'CashLimit';}, Type: 'BoYesNoEnum', Index: 16, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.MaxCashAmtForIncmngPayts = { valueOf: function(){return 'MaxCashAmtForIncmngPayts';}, Type: 'Edm.Double', Index: 17, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.LastLogoutDate = { valueOf: function(){return 'LastLogoutDate';}, Type: 'Edm.DateTime', Index: 18, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.LastLoginTime = { valueOf: function(){return 'LastLoginTime';}, Type: 'Edm.Time', Index: 19, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.LastLogoutTime = { valueOf: function(){return 'LastLogoutTime';}, Type: 'Edm.Time', Index: 20, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.LastPasswordChangeTime = { valueOf: function(){return 'LastPasswordChangeTime';}, Type: 'Edm.Time', Index: 21, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.LastPasswordChangedBy = { valueOf: function(){return 'LastPasswordChangedBy';}, Type: 'Edm.String', Index: 22, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.User.UserPermission = { valueOf: function(){return 'UserPermission';}, Type: 'UserPermissionItem', Index: 23, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.User.UserActionRecord = { valueOf: function(){return 'UserActionRecord';}, Type: 'UserActionRecordItem', Index: 24, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.User.UserBranchAssignment = { valueOf: function(){return 'UserBranchAssignment';}, Type: 'UserBranchAssignmentItem', Index: 25, Nullable: true, IsArray: true, IsComplex: true };
