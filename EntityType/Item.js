...
SAPB1.Item.AttachmentEntry = { valueOf: function(){return 'AttachmentEntry';}, Type: 'Edm.String', Index: 247, Nullable: true, IsArray: false, IsComplex: false };
...
SAPB1.Item.PricingUnit = { valueOf: function(){return 'PricingUnit';}, Type: 'Edm.Int32', Index: 259, Nullable: true, IsArray: false, IsComplex: false };
SAPB1.Item.ItemPrices = { valueOf: function(){return 'ItemPrices';}, Type: 'ItemPrice', Index: 260, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemWarehouseInfoCollection = { valueOf: function(){return 'ItemWarehouseInfoCollection';}, Type: 'ItemWarehouseInfo', Index: 261, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemPreferredVendors = { valueOf: function(){return 'ItemPreferredVendors';}, Type: 'ItemPreferredVendor', Index: 262, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemLocalizationInfos = { valueOf: function(){return 'ItemLocalizationInfos';}, Type: 'ItemLocalizationInfo', Index: 263, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemProjects = { valueOf: function(){return 'ItemProjects';}, Type: 'ItemProject', Index: 264, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemDistributionRules = { valueOf: function(){return 'ItemDistributionRules';}, Type: 'ItemDistributionRule', Index: 265, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemAttributeGroups = { valueOf: function(){return 'ItemAttributeGroups';}, Type: 'ItemAttributeGroups', Index: 266, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemDepreciationParameters = { valueOf: function(){return 'ItemDepreciationParameters';}, Type: 'ItemDepreciationParameter', Index: 267, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemPeriodControls = { valueOf: function(){return 'ItemPeriodControls';}, Type: 'ItemPeriodControl', Index: 268, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemUnitOfMeasurementCollection = { valueOf: function(){return 'ItemUnitOfMeasurementCollection';}, Type: 'ItemUnitOfMeasurement', Index: 269, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemBarCodeCollection = { valueOf: function(){return 'ItemBarCodeCollection';}, Type: 'ItemBarCode', Index: 270, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Item.ItemIntrastatExtension = { valueOf: function(){return 'ItemIntrastatExtension';}, Type: 'ItemIntrastatExtension', Index: 271, Nullable: true, IsArray: false, IsComplex: true };
...
SAPB1.Item.prototype.AttachmentEntry = new String();
