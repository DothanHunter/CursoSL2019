...
SAPB1.Document.Document_ApprovalRequests = { valueOf: function(){return 'Document_ApprovalRequests';}, Type: 'Document_ApprovalRequest', Index: 245, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DocumentLines = { valueOf: function(){return 'DocumentLines';}, Type: 'DocumentLine', Index: 246, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DocumentAdditionalExpenses = { valueOf: function(){return 'DocumentAdditionalExpenses';}, Type: 'DocumentAdditionalExpense', Index: 247, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.WithholdingTaxDataWTXCollection = { valueOf: function(){return 'WithholdingTaxDataWTXCollection';}, Type: 'WithholdingTaxDataWTX', Index: 248, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.WithholdingTaxDataCollection = { valueOf: function(){return 'WithholdingTaxDataCollection';}, Type: 'WithholdingTaxData', Index: 249, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DocumentPackages = { valueOf: function(){return 'DocumentPackages';}, Type: 'DocumentPackage', Index: 250, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DocumentSpecialLines = { valueOf: function(){return 'DocumentSpecialLines';}, Type: 'DocumentSpecialLine', Index: 251, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DocumentInstallments = { valueOf: function(){return 'DocumentInstallments';}, Type: 'DocumentInstallment', Index: 252, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.DownPaymentsToDraw = { valueOf: function(){return 'DownPaymentsToDraw';}, Type: 'DownPaymentToDraw', Index: 253, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.Document.TaxExtension = { valueOf: function(){return 'TaxExtension';}, Type: 'TaxExtension', Index: 254, Nullable: true, IsArray: false, IsComplex: true };
SAPB1.Document.AddressExtension = { valueOf: function(){return 'AddressExtension';}, Type: 'AddressExtension', Index: 255, Nullable: true, IsArray: false, IsComplex: true };
