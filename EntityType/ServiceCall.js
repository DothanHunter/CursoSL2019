...
SAPB1.ServiceCall.ServiceCallActivities = { valueOf: function(){return 'ServiceCallActivities';}, Type: 'ServiceCallActivity', Index: 81, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.ServiceCall.ServiceCallInventoryExpenses = { valueOf: function(){return 'ServiceCallInventoryExpenses';}, Type: 'ServiceCallInventoryExpense', Index: 82, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.ServiceCall.ServiceCallSolutions = { valueOf: function(){return 'ServiceCallSolutions';}, Type: 'ServiceCallSolution', Index: 83, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.ServiceCall.ServiceCallSchedulings = { valueOf: function(){return 'ServiceCallSchedulings';}, Type: 'ServiceCallScheduling', Index: 84, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.ServiceCall.ServiceCallBPAddressComponents = { valueOf: function(){return 'ServiceCallBPAddressComponents';}, Type: 'ServiceCallBPAddressComponent', Index: 85, Nullable: true, IsArray: true, IsComplex: true };
