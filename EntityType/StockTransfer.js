...
SAPB1.StockTransfer.StockTransfer_ApprovalRequests = { valueOf: function(){return 'StockTransfer_ApprovalRequests';}, Type: 'StockTransfer_ApprovalRequest', Index: 47, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.StockTransfer.StockTransferLines = { valueOf: function(){return 'StockTransferLines';}, Type: 'StockTransferLine', Index: 48, Nullable: true, IsArray: true, IsComplex: true };
SAPB1.StockTransfer.StockTransferTaxExtension = { valueOf: function(){return 'StockTransferTaxExtension';}, Type: 'StockTransferTaxExtension', Index: 49, Nullable: true, IsArray: false, IsComplex: true };
